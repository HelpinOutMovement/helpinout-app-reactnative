        ...
        <Container>
            ...
            <Footer>
                <FooterTab>
                    ...
                    <Button vertical onPress={() => props.navigation.navigate(AppConstant.APP_PAGE.MY_REQUEST_SCREEN)}>
                        <Icon name="camera" />
                        <Text>My Requests</Text>
                    </Button>
                    <Button vertical active onPress={() => props.navigation.navigate(AppConstant.APP_PAGE.MY_OFFERS_SCREEN)}>
