...
function SearchHelpGiversSeekers(props) {
    ...
    const [state, setState] = useState({ 
        region:props.route.params.params.region,
        address:props.route.params.params.address,
        activity_category:props.route.params.params.activity_category,
        activity_type:props.route.params.params.activity_type,
        activity_uuid:props.route.params.params.activity_uuid,
        ...
        mapHeight:verticalScale(340), 
        bottom_panel_bottom:height/2, 
        latlon: props.route.params.params.latlon   
      });
...
//   toggleBottomPanel()
    ...
    const renderScreen = () =>{
        ...
        console.log("MapComponent  latlon : " + props.route.params.params.latlon)
        console.log("MapComponent  latlon : " + state.latlon)
        console.log("MapComponent  latlon : " + JSON.stringify(state.region))
        return (
            <Container style={{ alignItems:"center"}}>

                <MapComponent  mapLatLon={props.route.params.params.latlon} mapHeight={state.mapHeight} callbackOnRegionChange={callbackOnRegionChange} mapProps={props} ref={mapComponentRef}>                      
                </MapComponent>  
