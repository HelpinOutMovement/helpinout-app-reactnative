                ...
                onPress={() => {
                    ...
                    if(props.activity_type === AppConstant.API_REQUEST_CONSTANTS.activity_type.Request){
                            if(props.buttonVal === AppConstant.APP_CONFIRMATION.YES){
                                navigation.navigate(AppConstant.APP_PAGE.SEARCH_HELP_GIVERS_SEEKERS, {activity_type:props.activity_type, activity_uuid:props.activity_uuid,activity_category:props.activity_category, latlon:props.latlon, region:{}, address:""})
